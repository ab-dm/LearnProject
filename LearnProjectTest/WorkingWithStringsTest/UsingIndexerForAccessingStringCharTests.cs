using LearnProject.WorkingWithStrings;
using NUnit.Framework;

namespace LearnProjectTest.WorkingWithStringsTest
{
    [TestFixture]
    public sealed class UsingIndexerForAccessingStringCharTests
    {
        ...
        [TestCase("07K4M1DZ-BZ", '7', '4', 'Z')] //10, 11  i = 3
        [TestCase("19K06M1DI-AZ", '9', '6', 'I')]//11, 12  i = 4
        [TestCase("31K008M1DJ-KZ", '1', '8', 'J')]//12, 13 i = 5
