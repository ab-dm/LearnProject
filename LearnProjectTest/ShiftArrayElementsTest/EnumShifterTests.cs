using LearnProject.ShiftArrayElements;
using NUnit.Framework;
using System;
using System.Linq;

namespace LearnProjectTest.ShiftArrayElementsTest
{
    [TestFixture]
    public class EnumShifterTests
    {
        ...
        public void Shift_SourceIsNull_ThrowsArgumentNullExceptionWithCorrectParameterName()
        {
            try
            {
                EnumShifter.Shift(null, Array.Empty<Direction>());
            }
        ...
        public void Shift_DirectionsIsNull_ThrowsArgumentNullExceptionWithCorrectParameterName()
        {
            try
            {
                EnumShifter.Shift(Array.Empty<int>(), null);
            }
