using LearnProject.SearchByPatternInText;
using NUnit.Framework;
using System;

namespace LearnProjectTest.SearchByPatternInTextTest
{
    [TestFixture]
    public class SearcherTests
    {
        ...
        public void SearchPatternString_TextIsNull_ThrowArgumentException()
        {
            Assert.Throws<ArgumentException>(
                () => Searcher.SearchPatternString(null, "pattern", false),
        ...
        {
            Assert.Throws<ArgumentException>(
                () => "source text".SearchPatternString(null, false),
