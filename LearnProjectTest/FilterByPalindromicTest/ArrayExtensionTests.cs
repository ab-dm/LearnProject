...
using static LearnProject.FilterByPalindromicTask.ArrayExtension;
using System;
using System.Linq;

namespace LearnProjectTest.FilterByPalindromicTest
{
    [TestFixture]
