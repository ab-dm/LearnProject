...
using System;
using System.Linq;
using static LearnProject.FindMaximumRecursion.ArrayExtension;

namespace LearnProjectTest.FindMaximumRecursionTest
{
    public class ArrayExtensionTests
    {
        ...
        public int FindMaximum_ReturnMaximumElement(int[] source) => FindMaximum(source);
